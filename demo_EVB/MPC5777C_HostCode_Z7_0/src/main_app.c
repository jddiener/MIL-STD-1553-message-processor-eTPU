/* main_app.c
 *
 * This contains the main app-level code
 */
...
/* t approx. represents microseconds */
...
int user_main()
{
	...
	/* on EVB, keep looping over the transfer sequence forever */
	while (1)
	{
		g_test_number = 0;
		...
		mt.rt_status_timeout = 14.0f;
		mt.transmit_delay = 10.0f;
		...
		rt.rt_status_timeout = 14.0f;
		rt.transmit_delay = 10.0f;
		...
		bc.rt_status_timeout = 14.0f;
		bc.transmit_delay = 10.0f;
    	...
    	/* pause briefly before performing transfer sequence again */
    	wait_time(10000);
	}
